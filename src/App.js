...
import ArrowContainer from './components/arrow_container';
...
function App() {
	...
	//Все 24 - это раньше были 32 (19 штук)
	...
	${props.x == 24 && props.y == 13 && props.isWin ? 'corner' : ""}
	...
	${props.x == 24 && props.y == 14 && props.isWin ? `cornerStatic ${props.firstAnimate ? '' : 'active'} ` : ""}
	${props.x == 24 && props.y == 15 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 16 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 17 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 18 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 19 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 20 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 21 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 22 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 23 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 24 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 25 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 26 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 27 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 28 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 29 && props.isWin ? 'cornerStatic active' : ""}
	${props.x == 24 && props.y == 30 && props.isWin ? `cornerStatic ${props.firstAnimate ? '' : 'active'} ` : ""}
	${props.x == 24 && props.y == 31 && props.isWin ? 'corner' : ""}
...
`;
	...
	class App extends React.Component {
		...
		moveFood() {
			...
			//Здесь было 28
			if (this.state.snake.length === 31) {
				const x = 22
				const y = 41


				return this.setState({
					food: [x, y], food2: [x, y - 1], food3: [x - 1, y - 1],
		...
		snakeWinGo() {
			...
			if (this.state.snake.length >= 30) {
				...
				function Child() {
					return (
						<div id="final_anim">
							<img src="final_anim.mov" alt="логотип" />
						</div>
					);
				}
		...
		render() {
			...
			if (this.state.status === 0) {
				...
				overlay = (
					<div className="snake-app__overlay">
						...
						<div className="mb-1">Нужно набрать 30 для выигрыша</div>
			...
			return (
				...
				>
					...
					<ArrowContainer setDirection={this.setDirection}/>
				</div>
	...
	ReactDOM.render(<App size={480} />, document.getElementById("root"));
}
